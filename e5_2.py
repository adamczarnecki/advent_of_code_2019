...
if __name__ == '__main__':
    ...
    intcode = [3, 21,               # 01 input to intcode[21]
               1008, 21, 8, 20,     # 05 if intcode[21] equal to 8 => intcode[20] = 1 else = 0
               1005, 20, 22,        # 08 if intcode[20] true jump to intcode[22]
               107, 8, 21, 20,      # 12 if if 8 is less than intcode[21] jump to intcode[intcode[20]]
               1006, 20, 31,        # 15 if intcode[20] false jump to intcode[31]
               1106, 0, 36,         # 19 if param false jump to intcode[36]
               98, 0, 0,            # 21 intcode[20] place to store if input == 8, intcode[21] place to store input
               1002, 21, 125, 20,   # 25 multiply intcode[21] and 125 and store intcode[intcode[20]]
               4, 20,               # 27 print intcode[20]
               1105, 1, 46,         # 30 if '1' True jump to intcode[46]
               104, 999,            # 32 print '999'
               1105, 1, 46,         # 35 if '1' True jump to intcode[46]
               1101, 1000, 1, 20,   # 39 add '1000' to '1' and store intcode[intcode[20]]
               4, 20,               # 41 print intcode[20]
               1105, 1, 46,         # 44 if '1' is True jump to intcode[46]
